...
def get_kv_cache_coordinator(
    ...
    # Only hybrid models (multiple KV cache groups) need the Ascend coordinator.
    # Single-group models must keep upstream UnitaryKVCacheCoordinator /
    # KVCacheCoordinatorNoPrefixCache to avoid hybrid-only asserts.

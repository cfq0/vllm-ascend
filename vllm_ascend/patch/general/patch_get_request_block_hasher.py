...
def get_hash_size(block_size: int) -> int:
    dcp_size = _VLLM_CONFIG_SNAPSHOT.get("decode_context_parallel_size", 1) or 1
    pcp_size = _VLLM_CONFIG_SNAPSHOT.get("prefill_context_parallel_size", 1) or 1
    cache_block_size = _VLLM_CONFIG_SNAPSHOT.get("block_size", 1) or 1
